...
namespace UI
{
    public class FPSCounter : MonoBehaviour
    {
        ...
        private static readonly string[] StringsFrom00To300 =
        {
        ...
        protected virtual void Update()
        {
            ...
            if (_timeLeft <= 0.0)
            {
                ...
                if (_currentFPS is >= 0 and <= 300)
                {
                    switch (Mode)
                    {
                        case Modes.Instant:
                            _text.text = StringsFrom00To300[_currentFPS];
                            break;
                        case Modes.MovingAverage:
                            _text.text = StringsFrom00To300[_average];
                            break;
                        case Modes.InstantAndMovingAverage:
                            _text.text = StringsFrom00To300[_currentFPS] + " / " + StringsFrom00To300[_average];
                            break;
                    }
                }
            }
